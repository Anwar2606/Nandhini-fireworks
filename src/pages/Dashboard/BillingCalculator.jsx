...
const generatePDF = (copyType, invoiceNumber) => {
  ...
  doc.addImage(imgData, 'JPEG', 17, 22, 22, 22);
    ...
    doc.text('559,Kankarseval, Sivakasi-626123', 44, 28);
    doc.setFontSize(9);
    doc.setFont('helvetica', 'bold');
    doc.text('Phone number:', 44, 35); // Regular text
   doc.setFont('helvetica', 'normal');
   doc.text('+91 97867 69539', 68, 35); // Bold text
    doc.setFont('helvetica', 'bold');
    ...
    doc.setFont('helvetica', 'bold');
     ...
     doc.text(`Invoice Number: NF-${invoiceNumber}-24`, 138, 43);
     doc.setTextColor(0, 0, 0);
doc.setFont('helvetica', 'normal');
doc.setFontSize(9);
...
{showCustomerDetails && (
  <div className="customer-details">
    {/* Close Button */}
    <button className="close-button" onClick={() => setShowCustomerDetails(false)}>
      x
    </button>
